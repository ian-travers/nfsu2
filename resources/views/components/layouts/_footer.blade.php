...
<footer class="bg-nfsu-color border-t border-gray-600 text-blue-400" aria-labelledby="footer-heading">
    ...
    <div class="max-w-screen-2xl mx-auto py-4 px-4 sm:px-6 lg:py-10 lg:px-8">
