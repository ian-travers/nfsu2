            ...
            <div class="mt-12 grid grid-cols-2 gap-8 xl:mt-0 xl:col-span-2">
                <div class="md:grid md:grid-cols-2 md:gap-8">
                    <div>
                        ...
                        <ul role="list" class="mt-4 space-y-1">
                            <li>
                                <a href="{{ route('page', 'tourneys') }}"
                                   class="text-base text-blue-400 hover:text-blue-300 hover:underline transition">
                                    {{ __('Tourneys') }}
                                </a>
                            </li>

                            <li>
                                <a href="{{ route('page', 'competitions') }}"
                                   class="text-base text-blue-400 hover:text-blue-300 hover:underline transition">
                                    {{ __('Competitions') }}
                                </a>
                            </li>
                ...
                <div class="md:grid md:grid-cols-2 md:gap-8">
                    ...
                    <div class="mt-12 md:mt-0">
                        ...
                        <ul role="list" class="mt-4 space-y-1">
                            <li>
                                <a href="{{ route('seasons-archive.index') }}"
                                   class="text-base text-blue-400 hover:text-blue-300 hover:underline transition">
                                    {{ __('Seasons') }}
                                </a>
                            </li>
                            ...
                            <li>
                                <a href="{{ route('competitions.archive') }}"
                                   class="text-base text-blue-400 hover:text-blue-300 hover:underline transition">
                                    {{ __('Competitions') }}
                                </a>
                            </li>
