<div>
    <p class="my-6">
        <x-form.primary-button wire:click="$set('showDialog', true)">{{ __('Announce the final round') }}</x-form.primary-button>
    </p>
    ...
    <x-modals.light wire:model.defer="showDialog">
        ...
        {{ __('Now the final heat racers will be available for viewing on the tourney page. Continue?') }}
        <x-slot name="footer">
