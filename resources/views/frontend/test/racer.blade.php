...
<x-layouts.front title="{{ $title }}">
    <div class="mt-3 md:mt-4 mx-auto px-4 md:px-8 text-blue-400 max-w-screen-2xl">
        ...
        <p class="leading-5 text-lg">{{ __('This test will find out how well you know the Rules of the NFSU Cup. When you pass this test you will be promoted to racer and will be able to participate in tourneys. You may only make one mistake.') }}</p>
